...
class CustomCSSandJS_Notices {
    ...
    public function get_message( $notice ) {
        ...
        if ( $notice == '12_days' ) {
            $link = 'https://www.silkypress.com/simple-custom-css-js-pro-offer/?utm_source=wordpress&utm_campaign=ccj_free&utm_medium=banner';
        } else {
            $link = 'https://www.silkypress.com/simple-custom-css-js-pro-special-offer/?a=' . $this->convert_numbers_letters( $this->activation_time ) . '&utm_source=wordpress&utm_campaign=ccj_free&utm_medium=banner';
        }
